...
#    regression_model = './models/segnet_3_inference.prototxt'
#    regression_weights = './weights/segnet_3_iter_120000.caffemodel'
#    regression_weights = './weights/segnet_3_iter_88000.caffemodel'

    # SegNet
    regression_model = './models/segnet_4_inference.prototxt'
#    regression_weights = './weights/segnet_4_center_of_mass/segnet_4_iter_162000.caffemodel'  # first submission
#    regression_weights = './weights/segnet_4_center_of_mass/segnet_4_iter_120000.caffemodel'  # 4.6  8.0
#    regression_weights = './weights/segnet_4_center_of_mass/segnet_4_iter_112000.caffemodel'  # 4.6  7.9
#    regression_weights = './weights/segnet_4_center_of_mass/segnet_4_iter_104000.caffemodel'  # 4.3  7.6
#    regression_weights = './weights/segnet_4_center_of_mass/segnet_4_iter_84000.caffemodel'   # 4.6  8.4 - second submission
#    regression_weights = './weights/segnet_4_center_of_mass/segnet_4_iter_78000.caffemodel'   # 4.5  7.9
#    regression_weights = './weights/segnet_4_center_of_mass/segnet_4_iter_72000.caffemodel'   # 4.2  7.5
#    regression_weights = './weights/segnet_4_iter_138000.caffemodel'
#    regression_weights = './weights/segnet_4_iter_83000.caffemodel'   # 4.6   8.4
    # Large batch (15)
